...
class SingleNode(Topo):
    def __init__(self):
        ...
        for i in range(16):
            self.addHost("h" + str(i + 1), mac='00:00:00:00:00:' + int_to_hex(i + 1))
...
class FatTree(Topo):
    def __init__(self):
        ...
        for i in range(1, 9):
            ...
            self.addHost("h" + str(i * 2 - 1), mac='00:00:00:00:00:' + int_to_hex(i * 2 - 1))
            self.addHost("h" + str(i * 2), mac='00:00:00:00:00:' + int_to_hex(i * 2))
...
def start_client_sequential(net):
    ...
    for i in range(16):
        ...
        for j in range(4):
            client.cmd('iperf -c ' + server_ip + ' -u -p ' + str(5000 + j) + ' -b 1M -t 650 &')
            time.sleep(1)
